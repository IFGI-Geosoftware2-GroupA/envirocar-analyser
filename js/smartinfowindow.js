...
SmartInfoWindow.prototype.draw = function() {
  ...
  switch (alignment) {
    ...
    case SmartInfoWindow.Align.LEFT:
      ...
      this.offsetX_ = -(this.width_) + 4;
      this.offsetY_ = -(this.height_ / 2 + 28);
      widthLess = 20;
      break;
  ...
  this.div_.style.background = 'url("img/smartinfowindow/' + image + '")';
...
SmartInfoWindow.prototype.createElement = function() {
  ...
  if (!div) {
    ...
    closeImg.src = 'img/smartinfowindow/closebigger.gif';
	...
	//Adding Listener to close SmartInfoWindow if user "clicks" into map
	google.maps.event.addListener(map,'click', removeSmartInfoWindow(this));
